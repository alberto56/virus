...
test('function obstacleBloqueChemin() test', t => {
  ...
  t.true(my.utilitaires().obstacleBloqueChemin(0, 0, 6, 6, 5, 2, 2, 5));
  t.true(my.utilitaires().obstacleBloqueChemin(0, 0, 100, 100, 150, 50, 50, 150));
  t.false(my.utilitaires().obstacleBloqueChemin(0, 0, 6, 6, 3, 2, 0, 1));
  t.true(my.utilitaires().obstacleBloqueChemin(1077, 155, 1127, 155, 161, 150, 1110, 1120));
  t.true(my.utilitaires().obstacleBloqueChemin(333, 185, 338, 185, 190, 180, 330, 340));
})
